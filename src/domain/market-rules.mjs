...
export const isRecommendationEligible=({technicalPass,total,themeEvidence,businessAvailable,intradayFresh,validPlan})=>Boolean(technicalPass&&total>=75&&themeEvidence&&businessAvailable&&intradayFresh&&validPlan)
