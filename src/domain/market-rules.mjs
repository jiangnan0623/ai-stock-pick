...
export const isRecommendationEligible=({technicalPass,total,themeEvidence,themeAuthentic,intradayFresh,validPlan})=>Boolean(technicalPass&&total>=75&&themeEvidence&&themeAuthentic&&intradayFresh&&validPlan)
